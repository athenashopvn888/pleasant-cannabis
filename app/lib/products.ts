...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Pleasant Cannabis?", a: "Yes! Visit us at 758 Mt Pleasant Rd, Toronto. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  PREROLLS: {
    ...
    seoDescription: "Skip the rolling and grab a pre-roll from Pleasant Cannabis in Toronto. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 758 Mt Pleasant Rd — open daily 24 hours.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Pleasant Cannabis, Toronto.",
    seoDescription: "Pleasant Cannabis carries a curated selection of magic mushrooms and specialty products in Toronto. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 758 Mt Pleasant Rd for our full selection.",
    faqs: [

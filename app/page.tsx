...
const LOCAL_FAQS = [
  ...
  },
  {
    ...
    a: "Pleasant Cannabis uses five dedicated flower tiers: Exotic Weed, Premium Weed, AAA+ Weed, AA Weed, and Budget Weed. Each collection offers a focused way to explore Cannabis Flower, while Pleasant Cannabis Weed in Toronto provides a broader starting point.",
  },
  {
          ...
          <div className={styles.storeGrid}>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                ...
                <br />
                <span className={styles.storeHighlight}>Mt Pleasant Rd & Eglinton Ave E, Toronto</span>
              </p>
            </div>
          </div>

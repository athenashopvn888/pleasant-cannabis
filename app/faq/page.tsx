...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about Pleasant Cannabis in Toronto. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Pleasant Cannabis located?", a: "We are located at 758 Mt Pleasant Rd, Toronto, ON M4S 2N6. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      { q: "Is Pleasant Cannabis open 24 hours?", a: "Yes. Pleasant Cannabis at 758 Mt Pleasant Rd in Toronto is a verified 24-hour location. Adult customers 19+ can use this page to review store details, hours, and menu/category links before visiting. Use the current store page or contact Pleasant Cannabis directly before visiting to confirm the latest store details, hours, and menu/category information." },
      ...
      { q: "What's the best way to get to Pleasant Cannabis?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at pleasantcannabis.ca updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No. Pleasant Cannabis is walk-in only. Use the current store page or contact Pleasant Cannabis directly before visiting to confirm the latest store details, hours, and menu/category information." },
      { q: "Can I order online?", a: "Currently, Pleasant Cannabis is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="Pleasant Cannabis FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Pleasant Cannabis — Toronto&apos;s premium dispensary at 758 Mt Pleasant Rd in Toronto.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(437) 427-0758</strong> or visit us at 758 Mt Pleasant Rd, Toronto.
            </p>
          </div>
        </div>
        <Footer />

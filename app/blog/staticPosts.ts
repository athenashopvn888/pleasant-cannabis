...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "editorialRemark": {
      ...
      "authorRole": "House Writer",
      "body": "The address check is not boring; it is the part that saves the trip. Store names and old tabs can blur together, so matching Mt Pleasant Rd, the phone number, and the current page is worth the minute. Check the category, check the current listing, then move. Simple beats heroic scrolling."
    },
  ...
  },
  {
    ...
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Pleasant Cannabis Desk",
      "authorHandle": "@PleasantDesk",
  ...
  },
  {
    ...
    "oldTitle": "Pleasant Cannabis Local Visit Guide for Adults 19+",
    "wordCount": 529,
    "businessReviewFlags": []
  }
];

...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("PCB01_age_verified");
    if (verified !== "true") {
  ...
  const handleVerify = () => {
    localStorage.setItem("PCB01_age_verified", "true");
    setShow(false);
  };
      ...
      <div className={styles.modal}>
        {underage ? (
          ...
          <div className={styles.promptState}>
            ...
            <p className={styles.text}>
              Pleasant Cannabis requires all visitors to be of legal age.
